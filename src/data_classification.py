...
CLASSIFICATION_ROWS = [
    ...
    },
    {
        ...
        "risk_level": "low_medium",
        "published_action": "keep",
        "business_need": "análise por seller sem expor identificador bruto",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
    ...
    {
        "asset": "fact_orders_dashboard",
        "column": "purchase_cohort_month",
        "layer": "published_dashboard",
        "classification": "analitico_agregado",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "análise de cohort e recorrência",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
        "column": "customer_order_sequence",
        "layer": "published_dashboard",
        "classification": "analitico_publico",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "ordem de compra do cliente em leitura de recorrência",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
        "column": "seller_volume_tier",
        "layer": "published_dashboard",
        "classification": "analitico_agregado",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "segmentação operacional de seller",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
        "column": "seller_delay_rate",
        "layer": "published_dashboard",
        "classification": "analitico_publico",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "desempenho logístico por seller",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
    ...
    {
        "asset": "fact_orders_dashboard",
        "column": "seller_dispatch_time_days",
        "layer": "published_dashboard",
        "classification": "analitico_publico",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "tempo de despacho para análise logística",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
        "column": "carrier_delivery_time_days",
        "layer": "published_dashboard",
        "classification": "analitico_publico",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "tempo de transporte até o cliente",
        "publication_allowed": True,
    },
    {
        "asset": "fact_orders_dashboard",
        "column": "freight_to_price_ratio",
        "layer": "published_dashboard",
        "classification": "analitico_publico",
        "risk_level": "low",
        "published_action": "keep",
        "business_need": "peso relativo do frete sobre o item",
        "publication_allowed": True,
    },
]
