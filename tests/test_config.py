...
def test_project_paths_validate_requires_enterprise_baseline_structure(tmp_path: Path) -> None:
    paths = ProjectPaths.from_root(tmp_path)
...
def test_project_paths_validate_accepts_existing_baseline_structure(tmp_path: Path) -> None:
